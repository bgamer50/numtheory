tests: tests/coprime_check_test_cases.x tests/crt_test_cases.x tests/euclidean_ext_test_cases.x tests/gcd_test_cases.x tests/mult_inv_test_cases.x tests/solve_linear_diophantine_test_cases.x
