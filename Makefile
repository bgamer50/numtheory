tests: tests/coprime_check_test_cases.x tests/crt_test_cases.x tests/euclidean_ext_test_cases.x tests/gcd_test_cases.x tests/mult_inv_test_cases.x tests/solve_linear_diophantine_test_cases.x tests/legendre_test_cases.x tests/tau_phi_sigma_test_cases.x tests/solve_linear_congruence_test_cases.x
...
tests/solve_linear_diophantine_test_cases.x: number_theory.o tests/solve_linear_diophantine_test_cases.o
	gcc number_theory.o tests/solve_linear_diophantine_test_cases.o -o tests/solve_linear_diophantine_test_cases.x

tests/legendre_test_cases.x: number_theory.o tests/legendre_test_cases.o
	gcc number_theory.o tests/legendre_test_cases.o -o tests/legendre_test_cases.x

tests/tau_phi_sigma_test_cases.x: number_theory.o tests/tau_phi_sigma_test_cases.o
	gcc number_theory.o tests/tau_phi_sigma_test_cases.o -o tests/tau_phi_sigma_test_cases.x

tests/solve_linear_congruence_test_cases.x: number_theory.o tests/solve_linear_congruence_test_cases.o
	gcc number_theory.o tests/solve_linear_congruence_test_cases.o -o tests/solve_linear_congruence_test_cases.x
